...
public struct FfiConverterTypeRelayMessage: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RelayMessage {
        ...
        case 4: return .endOfStoredEvents(
            subscriptionId: try FfiConverterString.read(from: &buf)
        )
...
public struct FfiConverterTypeTagEnum: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TagEnum {
        ...
        case 45: return .liveEventStatus(
        ...
        case 55: return .dataVendingMachineStatus(
    ...
    public static func write(_ value: TagEnum, into buf: inout [UInt8]) {
        ...
        case let .event(eventId,relayUrl,marker):
            writeInt(&buf, Int32(2))
        ...
        case let .publicKey(publicKey,relayUrl,alias):
            writeInt(&buf, Int32(3))
        ...
        case let .liveEventStatus(status):
        ...
        case let .dataVendingMachineStatus(status,extraInfo):
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_nostr_ffi_checksum_method_filter_author() != 50040) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nostr_ffi_checksum_method_filter_event() != 63303) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nostr_ffi_checksum_method_filter_events() != 64657) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nostr_ffi_checksum_method_filter_pubkey() != 40653) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nostr_ffi_checksum_method_filter_pubkeys() != 55370) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic() != 29939) {
        return InitializationResult.apiChecksumMismatch
    }
